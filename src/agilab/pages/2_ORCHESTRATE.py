        ...
        _orchestrate_notebook_cell(
            ...
            "\n".join(
                [
                    ...
                    "",
                    "Notebook import remains on the WORKFLOW page because import modifies workflow steps.",
                ]
            ),
        )
    ]
...
def _render_orchestrate_notebook_expander(env: Any) -> None:
    ...
    with st.expander("Notebook", expanded=False):
        st.caption(
            ...
            "Import stays in WORKFLOW because it changes workflow step definitions."
        )
        if not snippets:
