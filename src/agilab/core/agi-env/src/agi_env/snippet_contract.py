"""Compatibility shim for ``agi_env.snippet_contract``.

The implementation now lives in ``agi_env.source.snippet_contract``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.source.snippet_contract"
