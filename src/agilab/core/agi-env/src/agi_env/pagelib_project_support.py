"""Compatibility shim for ``agi_env.pagelib_project_support``.

The implementation now lives in ``agi_env.ui.pagelib_project_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.pagelib_project_support"
