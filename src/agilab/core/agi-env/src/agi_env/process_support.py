"""Compatibility shim for ``agi_env.process_support``.

The implementation now lives in ``agi_env.runtime.process_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.process_support"
