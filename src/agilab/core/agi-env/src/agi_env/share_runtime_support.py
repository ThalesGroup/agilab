"""Compatibility shim for ``agi_env.share_runtime_support``.

The implementation now lives in ``agi_env.shares.share_runtime_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.shares.share_runtime_support"
