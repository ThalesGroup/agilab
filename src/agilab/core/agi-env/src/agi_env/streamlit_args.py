"""Compatibility shim for ``agi_env.streamlit_args``.

The implementation now lives in ``agi_env.ui.streamlit_args``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.streamlit_args"
