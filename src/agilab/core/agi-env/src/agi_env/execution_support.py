"""Compatibility shim for ``agi_env.execution_support``.

The implementation now lives in ``agi_env.runtime.execution_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.execution_support"
