"""Compatibility shim for ``agi_env.connector_registry``.

The implementation now lives in ``agi_env.integrations.connector_registry``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.integrations.connector_registry"
