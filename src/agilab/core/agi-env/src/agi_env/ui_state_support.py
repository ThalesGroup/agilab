"""Compatibility shim for ``agi_env.ui_state_support``.

The implementation now lives in ``agi_env.ui.ui_state_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.ui_state_support"
