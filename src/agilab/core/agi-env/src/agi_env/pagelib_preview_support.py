"""Compatibility shim for ``agi_env.pagelib_preview_support``.

The implementation now lives in ``agi_env.ui.pagelib_preview_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.pagelib_preview_support"
