"""Compatibility shim for ``agi_env.repository_support``.

The implementation now lives in ``agi_env.runtime.repository_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.repository_support"
