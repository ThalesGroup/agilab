"""Compatibility shim for ``agi_env.worker_source_support``.

The implementation now lives in ``agi_env.project.worker_source_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.worker_source_support"
