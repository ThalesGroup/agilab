"""Compatibility shim for ``agi_env.host_runtime_support``.

The implementation now lives in ``agi_env.runtime.host_runtime_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.host_runtime_support"
