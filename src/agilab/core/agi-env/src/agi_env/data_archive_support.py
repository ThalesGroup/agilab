"""Compatibility shim for ``agi_env.data_archive_support``.

The implementation now lives in ``agi_env.project.data_archive_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.data_archive_support"
