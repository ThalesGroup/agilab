"""Compatibility shim for ``agi_env.app_args``.

The implementation now lives in ``agi_env.project.app_args``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.app_args"
