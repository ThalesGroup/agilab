"""Compatibility shim for ``agi_env.source_analysis_support``.

The implementation now lives in ``agi_env.source.source_analysis_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.source.source_analysis_support"
