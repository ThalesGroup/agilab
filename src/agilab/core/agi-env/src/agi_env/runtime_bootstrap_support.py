"""Compatibility shim for ``agi_env.runtime_bootstrap_support``.

The implementation now lives in ``agi_env.runtime.runtime_bootstrap_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.runtime_bootstrap_support"
