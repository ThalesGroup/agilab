"""Compatibility shim for ``agi_env.pagelib_session_support``.

The implementation now lives in ``agi_env.ui.pagelib_session_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.pagelib_session_support"
