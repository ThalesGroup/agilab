"""Compatibility shim for ``agi_env.installation_support``.

The implementation now lives in ``agi_env.runtime.installation_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.installation_support"
