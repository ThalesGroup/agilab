"""Compatibility shim for ``agi_env.bootstrap_support``.

The implementation now lives in ``agi_env.runtime.bootstrap_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.bootstrap_support"
