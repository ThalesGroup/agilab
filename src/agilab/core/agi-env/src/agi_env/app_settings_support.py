"""Compatibility shim for ``agi_env.app_settings_support``.

The implementation now lives in ``agi_env.project.app_settings_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.app_settings_support"
