"""Compatibility shim for ``agi_env.project_clone_support``.

The implementation now lives in ``agi_env.project.project_clone_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.project_clone_support"
