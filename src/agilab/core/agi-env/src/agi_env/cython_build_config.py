"""Compatibility shim for ``agi_env.cython_build_config``.

The implementation now lives in ``agi_env.runtime.cython_build_config``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.cython_build_config"
