"""Compatibility shim for ``agi_env.worker_runtime_support``.

The implementation now lives in ``agi_env.runtime.worker_runtime_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.worker_runtime_support"
