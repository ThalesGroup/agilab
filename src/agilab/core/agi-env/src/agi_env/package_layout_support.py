"""Compatibility shim for ``agi_env.package_layout_support``.

The implementation now lives in ``agi_env.runtime.package_layout_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.package_layout_support"
