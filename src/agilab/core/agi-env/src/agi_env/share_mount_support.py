"""Compatibility shim for ``agi_env.share_mount_support``.

The implementation now lives in ``agi_env.shares.share_mount_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.shares.share_mount_support"
