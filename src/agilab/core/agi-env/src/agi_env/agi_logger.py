"""Compatibility shim for ``agi_env.agi_logger``.

The implementation now lives in ``agi_env.runtime.agi_logger``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.agi_logger"
