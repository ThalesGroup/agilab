"""Compatibility shim for ``agi_env.hook_support``.

The implementation now lives in ``agi_env.runtime.hook_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.hook_support"
