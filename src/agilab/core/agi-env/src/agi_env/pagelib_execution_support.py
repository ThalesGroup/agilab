"""Compatibility shim for ``agi_env.pagelib_execution_support``.

The implementation now lives in ``agi_env.ui.pagelib_execution_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.ui.pagelib_execution_support"
