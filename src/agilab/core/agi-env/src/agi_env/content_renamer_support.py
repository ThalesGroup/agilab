"""Compatibility shim for ``agi_env.content_renamer_support``.

The implementation now lives in ``agi_env.project.content_renamer_support``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.content_renamer_support"
