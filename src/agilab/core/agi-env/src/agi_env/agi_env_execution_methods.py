"""Compatibility shim for ``agi_env.agi_env_execution_methods``.

The implementation now lives in ``agi_env.runtime.agi_env_execution_methods``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.runtime.agi_env_execution_methods"
