"""Compatibility shim for ``agi_env.mlflow_store``.

The implementation now lives in ``agi_env.integrations.mlflow_store``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.integrations.mlflow_store"
