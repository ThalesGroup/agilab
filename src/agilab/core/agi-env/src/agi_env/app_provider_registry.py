"""Compatibility shim for ``agi_env.app_provider_registry``.

The implementation now lives in ``agi_env.project.app_provider_registry``. Keep this shim so existing
...
_TARGET_MODULE = "agi_env.project.app_provider_registry"
