...
def args():
    return {'data_source': 'file', 'datemin': '2020-01-01', 'datemax':
        '2021-01-01', 'files': 'csv/*', 'nfile': 1, 'nread': 0, 'nskip': 0,
        'output_format': 'parquet', 'path': 'data/titi/dataset',
        'sampling_rate': 10.0, 'verbose': True}
