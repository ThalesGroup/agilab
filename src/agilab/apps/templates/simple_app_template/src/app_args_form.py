...
import simple_app as args_module
from simple_app import SimpleAppArgs as ArgsModel
...
def render() -> None:
    ...
    st.caption("Simple app template: local manager process, no worker deployment.")
