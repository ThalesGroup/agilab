...
from learning_assessment.reduction import write_reduce_artifact
...
class LearningAssessmentWorker(PandasWorker):
    ...
    def start(self):
        ...
        self.artifact_dir = _artifact_dir(self.env, "learning_assessment")
