"""Compatibility shim for learning_assessment.app_args.

The implementation now lives in learning_assessment.runtime.app_args. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.runtime.app_args"
