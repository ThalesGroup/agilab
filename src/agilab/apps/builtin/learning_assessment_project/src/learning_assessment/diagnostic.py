"""Compatibility shim for learning_assessment.diagnostic.

The implementation now lives in learning_assessment.domain.diagnostic. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.domain.diagnostic"
