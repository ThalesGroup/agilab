"""Compatibility shim for learning_assessment.classroom.

The implementation now lives in learning_assessment.domain.classroom. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.domain.classroom"
