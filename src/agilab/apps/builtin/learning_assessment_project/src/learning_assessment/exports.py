"""Compatibility shim for learning_assessment.exports.

The implementation now lives in learning_assessment.domain.exports. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.domain.exports"
