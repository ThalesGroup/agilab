"""Compatibility shim for learning_assessment.app_surface.

The implementation now lives in learning_assessment.ui.app_surface. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.ui.app_surface"
