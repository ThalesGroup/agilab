"""Compatibility shim for learning_assessment.curriculum.

The implementation now lives in learning_assessment.domain.curriculum. Keep this shim so existing
...
_TARGET_MODULE = "learning_assessment.domain.curriculum"
