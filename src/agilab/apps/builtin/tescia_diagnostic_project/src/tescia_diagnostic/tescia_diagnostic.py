"""Compatibility shim for tescia_diagnostic.tescia_diagnostic.

The implementation now lives in tescia_diagnostic.runtime.tescia_diagnostic. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.runtime.tescia_diagnostic"
