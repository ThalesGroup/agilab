"""Compatibility shim for tescia_diagnostic.exports.

The implementation now lives in tescia_diagnostic.domain.exports. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.domain.exports"
