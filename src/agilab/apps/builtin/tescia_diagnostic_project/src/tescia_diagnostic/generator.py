"""Compatibility shim for tescia_diagnostic.generator.

The implementation now lives in tescia_diagnostic.domain.generator. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.domain.generator"
