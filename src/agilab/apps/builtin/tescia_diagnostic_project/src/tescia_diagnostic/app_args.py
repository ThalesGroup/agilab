"""Compatibility shim for tescia_diagnostic.app_args.

The implementation now lives in tescia_diagnostic.runtime.app_args. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.runtime.app_args"
