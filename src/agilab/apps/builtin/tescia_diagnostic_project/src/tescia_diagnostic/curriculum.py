"""Compatibility shim for tescia_diagnostic.curriculum.

The implementation now lives in tescia_diagnostic.domain.curriculum. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.domain.curriculum"
