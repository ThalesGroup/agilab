"""Compatibility shim for tescia_diagnostic.classroom.

The implementation now lives in tescia_diagnostic.domain.classroom. Keep this shim so existing
...
_TARGET_MODULE = "tescia_diagnostic.domain.classroom"
