...
The [packaged SVG](src/tescia_diagnostic/resources/ml_landscape_axes.svg) separates
...
The [reading guide](src/tescia_diagnostic/curriculum/ml_landscape_2026.json)
...
The probability-density module includes an [area plot](src/tescia_diagnostic/resources/ml_probability_density.svg):
