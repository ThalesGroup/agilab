...
from r_runtime_bridge.app_args import RRuntimeBridgeArgs, dump_args, load_args


PAGE_ID = "r_runtime_bridge_project:app_args_form"
...
def _load_current_args(settings_path: Path) -> RRuntimeBridgeArgs:
    try:
...
st.caption(
    "R Runtime Bridge runs an external Rscript stage through a JSON input/output and artifact-directory contract. "
