...
from .app_args import ArgsOverrides, MinimalAppArgs, dump_args, ensure_defaults, load_args, merge_args

logger = logging.getLogger(__name__)


class MinimalApp(BaseWorker):
    """Lightweight orchestration surface for the minimal_app example."""
    ...
    def stop(self) -> None:
        if self.verbose > 0:
            print("MinimalApp worker completed.\n", end="")
        super().stop()
