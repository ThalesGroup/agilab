"""Compatibility shim for ``pytorch_playground.pytorch_playground``.

The implementation now lives in ``pytorch_playground.runtime.pytorch_playground``. Keep this shim so existing
...
_TARGET_MODULE = "pytorch_playground.runtime.pytorch_playground"
