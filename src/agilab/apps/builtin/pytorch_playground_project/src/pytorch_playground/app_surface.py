"""Compatibility shim for ``pytorch_playground.app_surface``.

The implementation now lives in ``pytorch_playground.ui.app_surface``. Keep this shim so existing
...
_TARGET_MODULE = "pytorch_playground.ui.app_surface"
