...
async def main():
  ...
  res = await BaseWorker.run({'127.0.0.1': 1}, mode=0, verbose=True, args={'data_source': 'file', 'path': 'data/flight/dataset', 'files': 'csv/*', 'nfile': 2, 'nskip': 0, 'nread': 0, 'sampling_rate': 1.0, 'datemin': '2020-01-01', 'datemax': '2021-01-01', 'output_format': 'csv'})
  print(res)
