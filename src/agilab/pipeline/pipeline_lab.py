...
_code_editor_support_module = import_agilab_module(
    ...
    fallback_path=Path(__file__).resolve().parents[1] / "components/code_editor_support.py",
...
_generated_actions_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "workflow/generated_actions.py",
...
_pinned_expander_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "ui/pinned_expander.py",
...
_workflow_ui_module = import_agilab_module(
    "agilab.workflow_ui",
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "workflow/workflow_ui.py",
...
_run_manifest_module = import_agilab_module(
    "agilab.run_manifest",
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "evidence/run_manifest.py",
...
_snippet_registry_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "workflow/snippet_registry.py",
...
_dag_run_engine_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "dag/dag_run_engine.py",
...
_workflow_run_manifest_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "workflow/workflow_run_manifest.py",
...
_evidence_graph_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "evidence/evidence_graph.py",
...
_multi_app_dag_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "dag/multi_app_dag.py",
...
_multi_app_dag_draft_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "dag/multi_app_dag_draft.py",
...
_multi_app_dag_templates_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "dag/multi_app_dag_templates.py",
...
_dag_distributed_submitter_module = import_agilab_module(
    ...
    current_file=__file__,
    fallback_path=Path(__file__).resolve().parents[1] / "dag/dag_distributed_submitter.py",
...
def _global_runner_dag_path(env: AgiEnv, repo_root: Path) -> Path | None:
    ...
    preferred = (
        ...
        if app_name in {"flight_telemetry", "flight_telemetry_project"}
