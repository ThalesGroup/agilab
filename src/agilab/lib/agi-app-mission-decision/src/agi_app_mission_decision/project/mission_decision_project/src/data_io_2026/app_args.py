"""Argument helpers for the public Mission Decision demo."""
...
class DataIo2026Args(BaseModel):
    ...
    data_in: Path = Field(default_factory=lambda: Path("mission_decision/scenarios"))
    data_out: Path = Field(default_factory=lambda: Path("mission_decision/results"))
    files: str = "*.json"
