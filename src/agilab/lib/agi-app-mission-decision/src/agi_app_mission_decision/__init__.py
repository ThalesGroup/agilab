"""Installed AGILAB app project provider for mission_decision_project."""

from __future__ import annotations

from pathlib import Path

APP_SLUG = 'mission_decision'
PROJECT_NAME = 'mission_decision_project'
PACKAGE_NAME = 'agi-app-mission-decision'
