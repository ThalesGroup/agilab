"""Compatibility shim for ``agi_gui.file_picker``.

The implementation now lives in ``agi_gui.widgets.file_picker``. Keep this shim so
...
_TARGET_MODULE = "agi_gui.widgets.file_picker"
