"""Installed AGILAB app project provider for sklearn_pipeline_project."""

from __future__ import annotations

from pathlib import Path

APP_SLUG = "sklearn_pipeline"
PROJECT_NAME = "sklearn_pipeline_project"
PACKAGE_NAME = "agi-app-sklearn-pipeline"
