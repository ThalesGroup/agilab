"""Manager for the built-in Weather forecast project."""
...
class WeatherForecast(BaseWorker):
    ...
    def __init__(
        ...
        **kwargs: ArgsOverrides,
        ...
        try:
            ...
            raise ValueError(f"Invalid WeatherForecast data_in/data_out path: {exc}") from exc
    ...
    def _ensure_dataset(self, data_in: Path) -> None:
        ...
        logger.info("Seeded Weather forecast sample dataset at %s", destination)
