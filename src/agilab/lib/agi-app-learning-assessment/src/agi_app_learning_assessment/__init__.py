"""Installed AGILAB app project provider for learning_assessment_project."""

from __future__ import annotations

from pathlib import Path

APP_SLUG = 'learning_assessment'
PROJECT_NAME = 'learning_assessment_project'
PACKAGE_NAME = 'agi-app-learning-assessment'
