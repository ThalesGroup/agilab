"""Installed AGILAB app project provider for data_io_2026_project."""

from __future__ import annotations

from pathlib import Path

APP_SLUG = 'data_io_2026'
PROJECT_NAME = 'data_io_2026_project'
PACKAGE_NAME = 'agi-app-data-io-2026-project'
