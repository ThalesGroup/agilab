"""Installed AGILAB app project provider for meteo_forecast_project."""

from __future__ import annotations

from pathlib import Path

APP_SLUG = 'meteo_forecast'
PROJECT_NAME = 'meteo_forecast_project'
PACKAGE_NAME = 'agi-app-meteo-forecast-project'
