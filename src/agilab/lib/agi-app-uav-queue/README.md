...
`agi-app-uav-queue` packages the `uav_queue_project` AGILAB app. It is
...
The distribution name is `agi-app-uav-queue`; the AGILAB project name is
...
```bash
pip install /path/to/agi_app_uav_queue-<version>-py3-none-any.whl
```
