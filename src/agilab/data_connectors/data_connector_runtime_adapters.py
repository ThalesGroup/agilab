...
from agilab.data_connectors.data_connector_cloud import (
    object_storage_runtime_dependency,
...
from agilab.security.secret_uri import credential_env_name
...
def _adapter_definition(connector: Mapping[str, Any]) -> dict[str, str]:
    ...
    if kind == "object_storage":
        ...
        return {
            ...
            "runtime_dependency": object_storage_runtime_dependency(provider),
        }
    return {
