...
def configure_page_chrome(
    ...
    *,
    ...
    if get_docs_menu_items is None:
        from agilab.ui.page_docs import get_docs_menu_items as _get_docs_menu_items
...
def render_page_header(
    ...
    *,
    ...
    if render_pinned_expanders is None:
        from agilab.ui.pinned_expander import (
    ...
    if show_project_context and render_page_context is None:
        from agilab.workflow.workflow_ui import render_page_context as _render_page_context
