...
from agilab.app_management.template_contracts import TemplateContract, load_optional_template_contract
from agilab.ui.ui_performance import ui_discovery_cache_enabled
