...
DEFAULT_SCENARIOS: dict[str, RobotScenario] = {
    ...
    "isolated-project-page": RobotScenario(
        ...
        required_text="Project metrics,Source KLOC",
        action_timeout_seconds=30.0,
        page_timeout_seconds=300.0,
    ),
    "isolated-project-editor-page": RobotScenario(
        ...
        forbidden_text="Worker class,Source KLOC,Environment Health",
        action_timeout_seconds=30.0,
        page_timeout_seconds=300.0,
    ),
...
OPT_IN_SCENARIOS: dict[str, RobotScenario] = {
    ...
    "current-home-first-proof-golden-path": RobotScenario(
        ...
        description=(
            "Exercise the local first-proof path through Deploy scheduler & workers, CHECK, RUN/LOAD/EXPORT, "
    ...
    "hf-first-proof-install": RobotScenario(
        ...
        description=(
            "Run the hosted Hugging Face first-proof app Deploy scheduler & workers actions and "
