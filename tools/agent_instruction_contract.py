...
CONTRACTS: tuple[FileContract, ...] = (
    ...
    FileContract(
        ...
        purpose="agent correction ledger",
        max_lines=120,
        required_terms=(
            RequiredTerm("when-to-add", "## When to add a rule"),
            RequiredTerm("maintenance-contract", "## Maintenance contract"),
            RequiredTerm("current-rules", "## Current rules"),
