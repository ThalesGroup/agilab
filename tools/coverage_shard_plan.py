...
STATIC_AGI_GUI_CHUNKS: tuple[tuple[str, tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "src/agilab/test/test_data_connector_live_smoke_ssrf.py",
            "src/agilab/test/test_pipeline_ai_sandbox_modes.py",
            "src/agilab/test/test_about_ssh_host_key_policy.py",
            "src/agilab/test/test_pipeline_ai_code_safety.py",
            "src/agilab/test/test_orchestrate_app_args_import_scope.py",
            "src/agilab/core/test/test_worker_pool_support.py",
            "src/agilab/lib/agi-web/test",
            "test/test_action_execution.py",
            "test/test_agent_config_and_capabilities.py",
            "test/test_agent_experiment.py",
            "test/test_agent_tasks.py",
    ...
    (
        ...
        (
            ...
            "test/test_forecast_showcase.py",
            "test/test_free_threading_showcase.py",
            "test/test_milp_energy_showcase.py",
            "test/test_notebook_adoption.py",
            "test/test_notebook_agent.py",
            "test/test_notebook_app_runtime.py",
            "test/test_notebook_showcase.py",
            "test/test_text_showcase.py",
            "test/test_notebook_execution_plan.py",
            "test/test_notebook_prerequisites.py",
