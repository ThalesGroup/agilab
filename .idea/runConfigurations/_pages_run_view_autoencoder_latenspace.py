#!/usr/bin/env python3
"""Auto-generated runner for apps-page 'view_autoencoder_latenspace'."""
...
PAGE_DIR = PROJECT_SRC / "agilab" / "apps-pages" / "view_autoencoder_latenspace"
ENTRY_SCRIPT = PAGE_DIR / "src" / "view_autoencoder_latenspace" / "view_autoencoder_latenspace.py"
DEFAULT_ACTIVE_APP = Path(r"/Users/jpm/agilab/src/agilab/apps/flight_project") if True else None
PYTHON_CANDIDATES = (
