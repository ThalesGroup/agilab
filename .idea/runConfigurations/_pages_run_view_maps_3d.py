#!/usr/bin/env python3
"""Auto-generated runner for apps-page 'view_maps_3d'."""
...
PAGE_DIR = PROJECT_SRC / "agilab" / "apps-pages" / "view_maps_3d"
ENTRY_SCRIPT = PAGE_DIR / "src" / "view_maps_3d" / "view_maps_3d.py"
