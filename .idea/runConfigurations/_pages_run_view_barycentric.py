#!/usr/bin/env python3
"""Auto-generated runner for apps-page 'view_barycentric'."""
...
PAGE_DIR = PROJECT_SRC / "agilab" / "apps-pages" / "view_barycentric"
ENTRY_SCRIPT = PAGE_DIR / "src" / "view_barycentric" / "view_barycentric.py"
