...
def test_stale_topology_path_recovers_to_detected_topology_candidate():
    state = edge_selection.resolve_edges_picker_state(
        ...
        [
            "/home/agilab/clustershare/sb3_trainer/pipeline/trainer_routing/routing_edges.jsonl",
            "/home/agilab/clustershare/network_sim/pipeline/ilp_topology.gml",
        ],
    )

    assert state.choice == "/home/agilab/clustershare/network_sim/pipeline/ilp_topology.gml"
    assert state.edges_clean == "/home/agilab/clustershare/network_sim/pipeline/ilp_topology.gml"
...
def test_edge_selection_picker_helpers_cover_existing_and_fallback_paths(tmp_path: Path):
    ...
    assert edge_selection._preferred_recovery_candidate(
        ...
        [
            "/home/agilab/clustershare/network_sim/pipeline/ilp_topology.gml",
            "/home/agilab/clustershare/network_sim/pipeline/routing_edges.jsonl",
        ],
    ) == "/home/agilab/clustershare/network_sim/pipeline/routing_edges.jsonl"
    assert edge_selection._preferred_recovery_candidate(
        "custom-name.json",
