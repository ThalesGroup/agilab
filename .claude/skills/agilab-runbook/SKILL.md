...
- **High-frequency shortcuts**: prefer `python3 tools/agilab_dev.py <shortcut>` for repeated local
  ...
  for docs mirror sync plus stamp verification. Add `--print-only` to inspect the expanded commands.
