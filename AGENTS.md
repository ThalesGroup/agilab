...
| components | example_app test worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py |  | $USER_HOME$/wenv/example_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/example_worker && uv run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py | uv (example_worker) |
