...
| agilab | zip_all | $ProjectFileDir$/tools/zip_all.py | --dir2zip $FilePrompt$ --follow-app-links --exclude-dir docs --exclude-dir codex | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/tools/zip_all.py --dir2zip $FilePrompt$ --follow-app-links --exclude-dir docs --exclude-dir codex | uv (agilab) |
