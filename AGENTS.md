...
| agilab | flight AGI.distribute | $ProjectFileDir$/src/agilab/snippets/AGI.distribute-flight.py |  | $ProjectFileDir$/src/agilab/snippets | PYTHONUNBUFFERED=1 | cd $ProjectFileDir$/src/agilab/snippets && uv run python $ProjectFileDir$/src/agilab/snippets/AGI.distribute-flight.py | uv (flight_project) |
