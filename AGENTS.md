...
| agilab | example_app get_distrib | /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py |  | /Users/example/log/execute/example_app | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/log/execute/example_app && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py | uv (example_app_project) |
| agilab | example_app install | /Users/example/log/execute/example_app/AGI_install_example_app.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_install_example_app.py | uv (agi-cluster) |
| agilab | ilp get_distrib | /Users/example/log/execute/ilp/AGI_get_distrib_ilp.py |  | /Users/example/log/execute/ilp | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/log/execute/ilp && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/ilp/AGI_get_distrib_ilp.py | uv (example_app_project) |
| agilab | ilp install | /Users/example/log/execute/ilp/AGI_install_ilp.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/ilp/AGI_install_ilp.py | uv (agi-cluster) |
| agilab | lab_run test | /Users/example/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py | --openai-api-key "your-key" | /Users/example/agi-workspace/ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/agi-workspace/ && uv --preview-features extra-build-dependencies run python /Users/example/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py --openai-api-key "your-key" | uv (agilab) |
| agilab | example_app get_distrib | /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py |  | /Users/example/log/execute/example_app | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/log/execute/example_app && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py | uv (example_app_project) |
| agilab | example_app install | /Users/example/log/execute/example_app/AGI_install_example_app.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_install_example_app.py | uv (agi-cluster) |
| agilab | mycode get_distrib | /Users/example/log/execute/mycode/AGI_get_distrib_mycode.py |  | /Users/example/log/execute/mycode | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/log/execute/mycode && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/mycode/AGI_get_distrib_mycode.py | uv (mycode_project) |
| agilab | mycode install | /Users/example/log/execute/mycode/AGI_install_mycode.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/mycode/AGI_install_mycode.py | uv (agi-cluster) |
| agilab | example_app get_distrib | /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py |  | /Users/example/log/execute/example_app | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/log/execute/example_app && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_get_distrib_example_app.py | uv (example_app_project) |
| agilab | example_app install | /Users/example/log/execute/example_app/AGI_install_example_app.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_install_example_app.py | uv (agi-cluster) |
...
| apps | example_app run | /Users/example/log/execute/example_app/AGI_run_example_app.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_run_example_app.py | uv (example_app_project) |
...
| apps | ilp run | /Users/example/log/execute/ilp/AGI_run_ilp.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/ilp/AGI_run_ilp.py | uv (example_app_project) |
| apps | ilp test manager | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_ilp_manager.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_ilp_manager.py | uv (example_app_project) |
| apps | example_app run | /Users/example/log/execute/example_app/AGI_run_example_app.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/example_app/AGI_run_example_app.py | uv (example_app_project) |
| apps | example_app test manager | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_app_manager.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_app_manager.py | uv (example_app_project) |
| apps | mycode run | /Users/example/log/execute/mycode/AGI_run_mycode.py |  | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python /Users/example/log/execute/mycode/AGI_run_mycode.py | uv (mycode_project) |
...
| components | example_app_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/example_worker/src/example_worker/example_worker.py | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/example_worker/src/example_worker/example_worker.py | uv (example_app_project) |
| components | ilp call worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py | uv (example_app_project) |
| components | ilp test worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py | uv (example_worker) |
| components | ilp_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | uv (example_app_project) |
| components | ilp_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | /Users/example/wenv/example_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/wenv/example_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | uv (example_worker) |
| components | ilp_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/example_app_project /Users/example/data/ilp | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/example_app_project /Users/example/data/ilp | uv (example_worker) |
| components | ilp_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/example/wenv/example_worker/src/example_worker/example_worker.py | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/example/wenv/example_worker/src/example_worker/example_worker.py | uv (example_app_project) |
| components | example_app call worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py | uv (example_app_project) |
| components | example_app test worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py | uv (example_worker) |
| components | example_app_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/example_worker | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/example_worker | uv (example_app_project) |
| components | example_app_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/example_worker | $USER_HOME$/wenv/example_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/example_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/example_worker | uv (example_worker) |
...
| components | mycode_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/mycode_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/mycode_worker | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/mycode_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/mycode_worker | uv (mycode_project) |
| components | mycode_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/example/wenv/mycode_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/mycode_worker | /Users/example/wenv/mycode_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/wenv/mycode_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/example/wenv/mycode_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/mycode_worker | uv (mycode_worker) |
| components | mycode_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/mycode_project /Users/example/data/mycode | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/mycode_project /Users/example/data/mycode | uv (mycode_worker) |
| components | mycode_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/example/wenv/mycode_worker/src/mycode_worker/mycode_worker.py | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/example/wenv/mycode_worker/src/mycode_worker/mycode_worker.py | uv (mycode_project) |
| components | example_app call worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py | uv (example_app_project) |
| components | example_app test worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py | uv (example_worker) |
| components | example_app_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | uv (example_app_project) |
| components | example_app_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | /Users/example/wenv/example_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/wenv/example_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | uv (example_worker) |
| components | example_app_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/example_app_project /Users/example/data/example_app | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/example_app_project /Users/example/data/example_app | uv (example_worker) |
| components | example_app_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/example/wenv/example_worker/src/example_worker/example_worker.py | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/example/wenv/example_worker/src/example_worker/example_worker.py | uv (example_app_project) |
| components | example_app call worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_call_worker.py | uv (example_app_project) |
| components | example_app test worker | $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py |  | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/example_app_project/test/_test_example_worker.py | uv (example_worker) |
| components | example_app_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | $ProjectFileDir$/src/agilab/apps/example_app_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/example_app_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/example/wenv/example_worker | uv (example_app_project) |
| components | example_app_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | /Users/example/wenv/example_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/example/wenv/example_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/example/wenv/example_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/example/wenv/example_worker | uv (example_worker) |
...
- Troubleshooting:
  - Missing Python deps (e.g., `tomlkit`, `licensecheck`): run with `uv --preview-features extra-build-dependencies run --group sphinx --dev docs/gen-docs.py` from agilab-apps.
...
- Link model:
  - `cd src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python ../../examples/example_app/AGI_run_example_app.py`
  - `cd src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python test/_test_example_app_manager.py`
  - `cd src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python test/_test_example_worker.py`
  - `cd src/agilab/examples/example_app && uv --preview-features extra-build-dependencies run python AGI_get_distrib_example_app.py`
  - `cd src/agilab/apps/example_app_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
- MyCode:
...
3. Re-generate per‑app launchers (one per app)
   - Examples:
     ...
     - `uv --preview-features extra-build-dependencies run python pycharm/gen_app_script.py example_app`
