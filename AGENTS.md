...
- **Docs edits**: `docs/html` in this repo is generated; do not edit it directly. Update
  the docs sources in the apps repository (`thales_agilab/docs/source`) and regenerate.
...
| agilab | flight_clone get_distrib | $USER_HOME$/log/execute/flight_clone/AGI_get_distrib_flight_clone.py |  | $USER_HOME$/log/execute/flight_clone | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/flight_clone && uv run python $USER_HOME$/log/execute/flight_clone/AGI_get_distrib_flight_clone.py | uv (flight_clone_project) |
| agilab | flight_clone install | $USER_HOME$/log/execute/flight_clone/AGI_install_flight_clone.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $USER_HOME$/log/execute/flight_clone/AGI_install_flight_clone.py | uv (agi-cluster) |
| agilab | flight_legacy get_distrib | $USER_HOME$/log/execute/flight_legacy/AGI_get_distrib_flight_legacy.py |  | $USER_HOME$/log/execute/flight_legacy | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/flight_legacy && uv run python $USER_HOME$/log/execute/flight_legacy/AGI_get_distrib_flight_legacy.py | uv (flight_legacy_project) |
| agilab | flight_legacy install | $USER_HOME$/log/execute/flight_legacy/AGI_install_flight_legacy.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $USER_HOME$/log/execute/flight_legacy/AGI_install_flight_legacy.py | uv (agi-cluster) |
| agilab | flight_trajectory get_distrib | /Users/agi/log/execute/flight_trajectory/AGI_get_distrib_flight_trajectory.py |  | /Users/agi/log/execute/flight_trajectory | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/flight_trajectory && uv run python /Users/agi/log/execute/flight_trajectory/AGI_get_distrib_flight_trajectory.py | uv (flight_trajectory_project) |
| agilab | flight_trajectory install | /Users/agi/log/execute/flight_trajectory/AGI_install_flight_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python /Users/agi/log/execute/flight_trajectory/AGI_install_flight_trajectory.py | uv (agi-cluster) |
| agilab | ilp get_distrib | $USER_HOME$/log/execute/ilp/AGI_get_distrib_ilp.py |  | $USER_HOME$/log/execute/ilp | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/ilp && uv run python $USER_HOME$/log/execute/ilp/AGI_get_distrib_ilp.py | uv (ilp_project) |
| agilab | ilp install | $USER_HOME$/log/execute/ilp/AGI_install_ilp.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $USER_HOME$/log/execute/ilp/AGI_install_ilp.py | uv (agi-cluster) |
| agilab | lab_run test | /Users/agi/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py | --openai-api-key "your-key" | /Users/agi/agi-workspace/ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/agi-workspace/ && uv run python /Users/agi/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py --openai-api-key "your-key" | uv (agilab) |
| agilab | link_sim get_distrib | /Users/agi/log/execute/link_sim/AGI_get_distrib_link_sim.py |  | /Users/agi/log/execute/link_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/link_sim && uv run python /Users/agi/log/execute/link_sim/AGI_get_distrib_link_sim.py | uv (link_sim_project) |
| agilab | link_sim install | /Users/agi/log/execute/link_sim/AGI_install_link_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python /Users/agi/log/execute/link_sim/AGI_install_link_sim.py | uv (agi-cluster) |
| agilab | mycode get_distrib | /Users/agi/log/execute/mycode/AGI_get_distrib_mycode.py |  | /Users/agi/log/execute/mycode | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/mycode && uv run python /Users/agi/log/execute/mycode/AGI_get_distrib_mycode.py | uv (mycode_project) |
| agilab | mycode install | /Users/agi/log/execute/mycode/AGI_install_mycode.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python /Users/agi/log/execute/mycode/AGI_install_mycode.py | uv (agi-cluster) |
| agilab | network_sim get_distrib | $USER_HOME$/log/execute/network_sim/AGI_get_distrib_network_sim.py |  | $USER_HOME$/log/execute/network_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/network_sim && uv run python $USER_HOME$/log/execute/network_sim/AGI_get_distrib_network_sim.py | uv (network_sim_project) |
| agilab | network_sim install | $USER_HOME$/log/execute/network_sim/AGI_install_network_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $USER_HOME$/log/execute/network_sim/AGI_install_network_sim.py | uv (agi-cluster) |
...
| agilab | sat_trajectory get_distrib | /Users/agi/log/execute/sat_trajectory/AGI_get_distrib_sat_trajectory.py |  | /Users/agi/log/execute/sat_trajectory | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/sat_trajectory && uv run python /Users/agi/log/execute/sat_trajectory/AGI_get_distrib_sat_trajectory.py | uv (sat_trajectory_project) |
| agilab | sat_trajectory install | /Users/agi/log/execute/sat_trajectory/AGI_install_sat_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python /Users/agi/log/execute/sat_trajectory/AGI_install_sat_trajectory.py | uv (agi-cluster) |
| agilab | satcom_sim get_distrib | $USER_HOME$/log/execute/satcom_sim/AGI_get_distrib_satcom_sim.py |  | $USER_HOME$/log/execute/satcom_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/satcom_sim && uv run python $USER_HOME$/log/execute/satcom_sim/AGI_get_distrib_satcom_sim.py | uv (satcom_sim_project) |
| agilab | satcom_sim install | $USER_HOME$/log/execute/satcom_sim/AGI_install_satcom_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $USER_HOME$/log/execute/satcom_sim/AGI_install_satcom_sim.py | uv (agi-cluster) |
| agilab | sb3_trainer get_distrib | /Users/agi/log/execute/sb3_trainer/AGI_get_distrib_sb3_trainer.py |  | /Users/agi/log/execute/sb3_trainer | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/sb3_trainer && uv run python /Users/agi/log/execute/sb3_trainer/AGI_get_distrib_sb3_trainer.py | uv (sb3_trainer_project) |
| agilab | sb3_trainer install | /Users/agi/log/execute/sb3_trainer/AGI_install_sb3_trainer.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python /Users/agi/log/execute/sb3_trainer/AGI_install_sb3_trainer.py | uv (agi-cluster) |
...
| apps | flight_clone run | $USER_HOME$/log/execute/flight_clone/AGI_run_flight_clone.py |  | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $USER_HOME$/log/execute/flight_clone/AGI_run_flight_clone.py | uv (flight_clone_project) |
| apps | flight_clone test manager | $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_flight_clone_manager.py |  | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_flight_clone_manager.py | uv (flight_clone_project) |
| apps | flight_legacy run | $USER_HOME$/log/execute/flight_legacy/AGI_run_flight_legacy.py |  | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $USER_HOME$/log/execute/flight_legacy/AGI_run_flight_legacy.py | uv (flight_legacy_project) |
| apps | flight_legacy test manager | $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_flight_legacy_manager.py |  | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_flight_legacy_manager.py | uv (flight_legacy_project) |
| apps | flight_trajectory run | /Users/agi/log/execute/flight_trajectory/AGI_run_flight_trajectory.py |  | $ProjectFileDir$/src/agilab/apps/flight_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_trajectory_project && uv run python /Users/agi/log/execute/flight_trajectory/AGI_run_flight_trajectory.py | uv (flight_trajectory_project) |
...
| apps | ilp run | $USER_HOME$/log/execute/ilp/AGI_run_ilp.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $USER_HOME$/log/execute/ilp/AGI_run_ilp.py | uv (ilp_project) |
| apps | ilp test manager | $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_manager.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_manager.py | uv (ilp_project) |
| apps | link_sim run | /Users/agi/log/execute/link_sim/AGI_run_link_sim.py |  | $ProjectFileDir$/src/agilab/apps/link_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/link_sim_project && uv run python /Users/agi/log/execute/link_sim/AGI_run_link_sim.py | uv (link_sim_project) |
...
| apps | mycode run | /Users/agi/log/execute/mycode/AGI_run_mycode.py |  | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv run python /Users/agi/log/execute/mycode/AGI_run_mycode.py | uv (mycode_project) |
...
| apps | satcom_sim run | $USER_HOME$/log/execute/satcom_sim/AGI_run_satcom_sim.py |  | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $USER_HOME$/log/execute/satcom_sim/AGI_run_satcom_sim.py | uv (satcom_sim_project) |
| apps | satcom_sim test manager | $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_satcom_sim_manager.py |  | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_satcom_sim_manager.py | uv (satcom_sim_project) |
| apps | sb3_trainer run | /Users/agi/log/execute/sb3_trainer/AGI_run_sb3_trainer.py |  | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sb3_trainer_project && uv run python /Users/agi/log/execute/sb3_trainer/AGI_run_sb3_trainer.py | uv (sb3_trainer_project) |
...
| components | flight_clone call worker | $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_call_worker.py | uv (flight_clone_project) |
| components | flight_clone test worker | $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_flight_clone_worker.py |  | $USER_HOME$/wenv/flight_clone_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/flight_clone_worker && uv run python $ProjectFileDir$/src/agilab/apps/flight_clone_project/test/_test_flight_clone_worker.py | uv (flight_clone_worker) |
| components | flight_clone_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/flight_clone_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_clone_worker | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/flight_clone_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_clone_worker | uv (flight_clone_project) |
| components | flight_clone_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/flight_clone_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/flight_clone_worker | $USER_HOME$/wenv/flight_clone_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/flight_clone_worker && uv run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/flight_clone_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/flight_clone_worker | uv (flight_clone_worker) |
| components | flight_clone_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/flight_clone_project $USER_HOME$/data/flight_clone | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/flight_clone_project $USER_HOME$/data/flight_clone | uv (flight_clone_worker) |
| components | flight_clone_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_clone_worker/src/flight_clone_worker/flight_clone_worker.py | $ProjectFileDir$/src/agilab/apps/flight_clone_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_clone_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_clone_worker/src/flight_clone_worker/flight_clone_worker.py | uv (flight_clone_project) |
| components | flight_legacy call worker | $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_call_worker.py | uv (flight_legacy_project) |
| components | flight_legacy test worker | $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_flight_legacy_worker.py |  | $USER_HOME$/wenv/flight_legacy_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/flight_legacy_worker && uv run python $ProjectFileDir$/src/agilab/apps/flight_legacy_project/test/_test_flight_legacy_worker.py | uv (flight_legacy_worker) |
| components | flight_legacy_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/flight_legacy_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_legacy_worker | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/flight_legacy_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_legacy_worker | uv (flight_legacy_project) |
| components | flight_legacy_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/flight_legacy_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/flight_legacy_worker | $USER_HOME$/wenv/flight_legacy_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/flight_legacy_worker && uv run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/flight_legacy_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/flight_legacy_worker | uv (flight_legacy_worker) |
| components | flight_legacy_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/flight_legacy_project $USER_HOME$/data/flight_legacy | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/flight_legacy_project $USER_HOME$/data/flight_legacy | uv (flight_legacy_worker) |
| components | flight_legacy_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_legacy_worker/src/flight_legacy_worker/flight_legacy_worker.py | $ProjectFileDir$/src/agilab/apps/flight_legacy_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_legacy_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_legacy_worker/src/flight_legacy_worker/flight_legacy_worker.py | uv (flight_legacy_project) |
...
| components | ilp test worker | $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_worker.py |  | $USER_HOME$/wenv/ilp_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/ilp_worker && uv run python $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_worker.py | uv (ilp_worker) |
| components | ilp_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/ilp_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/ilp_worker | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/ilp_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/ilp_worker | uv (ilp_project) |
| components | ilp_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/ilp_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/ilp_worker | $USER_HOME$/wenv/ilp_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/ilp_worker && uv run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/ilp_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/ilp_worker | uv (ilp_worker) |
| components | ilp_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/ilp_project $USER_HOME$/data/ilp | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/ilp_project $USER_HOME$/data/ilp | uv (ilp_worker) |
| components | ilp_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | uv (ilp_project) |
| components | link_sim call worker | $ProjectFileDir$/src/agilab/apps/link_sim_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/link_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/link_sim_project && uv run python $ProjectFileDir$/src/agilab/apps/link_sim_project/test/_test_call_worker.py | uv (link_sim_project) |
| components | link_sim test worker | $ProjectFileDir$/src/agilab/apps/link_sim_project/test/_test_link_sim_worker.py |  | $USER_HOME$/wenv/link_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/link_sim_worker && uv run python $ProjectFileDir$/src/agilab/apps/link_sim_project/test/_test_link_sim_worker.py | uv (link_sim_worker) |
...
| components | network_sim test worker | $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_worker.py |  | $USER_HOME$/wenv/network_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/network_sim_worker && uv run python $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_worker.py | uv (network_sim_worker) |
| components | network_sim_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/network_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/network_sim_worker | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/network_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/network_sim_worker | uv (network_sim_project) |
| components | network_sim_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/network_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/network_sim_worker | $USER_HOME$/wenv/network_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/network_sim_worker && uv run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/network_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/network_sim_worker | uv (network_sim_worker) |
| components | network_sim_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/network_sim_project $USER_HOME$/data/network_sim | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/network_sim_project $USER_HOME$/data/network_sim | uv (network_sim_worker) |
| components | network_sim_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/network_sim_worker/src/network_sim_worker/network_sim_worker.py | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/network_sim_worker/src/network_sim_worker/network_sim_worker.py | uv (network_sim_project) |
...
| components | sat_trajectory test worker | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project/test/_test_sat_trajectory_worker.py |  | $USER_HOME$/wenv/sat_trajectory_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/sat_trajectory_worker && uv run python $ProjectFileDir$/src/agilab/apps/sat_trajectory_project/test/_test_sat_trajectory_worker.py | uv (sat_trajectory_worker) |
...
| components | satcom_sim call worker | $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_call_worker.py | uv (satcom_sim_project) |
| components | satcom_sim test worker | $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_satcom_sim_worker.py |  | $USER_HOME$/wenv/satcom_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/satcom_sim_worker && uv run python $ProjectFileDir$/src/agilab/apps/satcom_sim_project/test/_test_satcom_sim_worker.py | uv (satcom_sim_worker) |
| components | satcom_sim_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/satcom_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/satcom_sim_worker | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/satcom_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/satcom_sim_worker | uv (satcom_sim_project) |
| components | satcom_sim_lib gen | agi_node.agi_dispatcher.build | --app-path $USER_HOME$/wenv/satcom_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/satcom_sim_worker | $USER_HOME$/wenv/satcom_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/satcom_sim_worker && uv run python agi_node.agi_dispatcher.build --app-path $USER_HOME$/wenv/satcom_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/satcom_sim_worker | uv (satcom_sim_worker) |
| components | satcom_sim_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/satcom_sim_project $USER_HOME$/data/satcom_sim | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/satcom_sim_project $USER_HOME$/data/satcom_sim | uv (satcom_sim_worker) |
| components | satcom_sim_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/satcom_sim_worker/src/satcom_sim_worker/satcom_sim_worker.py | $ProjectFileDir$/src/agilab/apps/satcom_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/satcom_sim_project && uv run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/satcom_sim_worker/src/satcom_sim_worker/satcom_sim_worker.py | uv (satcom_sim_project) |
...
| components | sb3_trainer test worker | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project/test/_test_sb3_trainer_worker.py |  | $USER_HOME$/wenv/sb3_trainer_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/sb3_trainer_worker && uv run python $ProjectFileDir$/src/agilab/apps/sb3_trainer_project/test/_test_sb3_trainer_worker.py | uv (sb3_trainer_worker) |
