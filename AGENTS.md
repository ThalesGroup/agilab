...
- Sphinx docs in thales_agilab: from the `thales_agilab` repo root, run `uv run --group sphinx --dev docs/gen-docs.py` to build into `docs/html/`, then commit and push.
