...
|---|---|---|---|---|---|---|---|
| agilab | agilab run (dev) | streamlit | run $ProjectFileDir$/src/agilab/AGILAB.py -- --openai-api-key "your-key" --apps-dir $ProjectFileDir$/src/agilab/apps | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run streamlit run $ProjectFileDir$/src/agilab/AGILAB.py -- --openai-api-key "your-key" --apps-dir $ProjectFileDir$/src/agilab/apps | uv (agilab) |
| agilab | agilab run (enduser) | streamlit | run .venv/lib/python3.13/site-packages/agilab/AGILAB.py -- --openai-api-key "your-key" | $ProjectFileDir$/../agi-space | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/../agi-space && uv --preview-features extra-build-dependencies run streamlit run .venv/lib/python3.13/site-packages/agilab/AGILAB.py -- --openai-api-key "your-key" | uv (agi-space) |
| agilab | app_script gen | $ProjectFileDir$/pycharm/gen_app_script.py | $Prompt:Enter app manager name:flight$ |  | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | uv --preview-features extra-build-dependencies run python $ProjectFileDir$/pycharm/gen_app_script.py $Prompt:Enter app manager name:flight$ |  |
| agilab | apps-pages launcher | $ProjectFileDir$/tools/apps_pages_launcher.py | --active-app $ProjectFileDir$/src/agilab/apps/flight_project | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/apps_pages_launcher.py --active-app $ProjectFileDir$/src/agilab/apps/flight_project | uv (agilab) |
| agilab | apps-pages smoke | $ProjectFileDir$/tools/smoke_preinit.py | --active-app $ProjectFileDir$/src/agilab/apps/flight_project --timeout 20 | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/smoke_preinit.py --active-app $ProjectFileDir$/src/agilab/apps/flight_project --timeout 20 | uv (agilab) |
| agilab | flight get_distrib | $USER_HOME$/log/execute/flight/AGI_get_distrib_flight.py |  | $USER_HOME$/log/execute/flight | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/log/execute/flight && uv --preview-features extra-build-dependencies run python $USER_HOME$/log/execute/flight/AGI_get_distrib_flight.py | uv (flight_project) |
| agilab | flight install | $USER_HOME$/log/execute/flight/AGI_install_flight.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $USER_HOME$/log/execute/flight/AGI_install_flight.py | uv (agi-cluster) |
| agilab | flight_trajectory get_distrib | /Users/agi/log/execute/flight_trajectory/AGI_get_distrib_flight_trajectory.py |  | /Users/agi/log/execute/flight_trajectory | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/flight_trajectory && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/flight_trajectory/AGI_get_distrib_flight_trajectory.py | uv (flight_trajectory_project) |
| agilab | flight_trajectory install | /Users/agi/log/execute/flight_trajectory/AGI_install_flight_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/flight_trajectory/AGI_install_flight_trajectory.py | uv (agi-cluster) |
| agilab | ilp get_distrib | /Users/agi/log/execute/ilp/AGI_get_distrib_ilp.py |  | /Users/agi/log/execute/ilp | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/ilp && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/ilp/AGI_get_distrib_ilp.py | uv (ilp_project) |
| agilab | ilp install | /Users/agi/log/execute/ilp/AGI_install_ilp.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/ilp/AGI_install_ilp.py | uv (agi-cluster) |
| agilab | lab_run test | /Users/agi/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py | --openai-api-key "your-key" | /Users/agi/agi-workspace/ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/agi-workspace/ && uv --preview-features extra-build-dependencies run python /Users/agi/agi-workspace/.venv/lib/python3.12/site-packages/agilab/lab_run.py --openai-api-key "your-key" | uv (agilab) |
| agilab | link_sim get_distrib | /Users/agi/log/execute/link_sim/AGI_get_distrib_link_sim.py |  | /Users/agi/log/execute/link_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/link_sim && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/link_sim/AGI_get_distrib_link_sim.py | uv (link_sim_project) |
| agilab | link_sim install | /Users/agi/log/execute/link_sim/AGI_install_link_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/link_sim/AGI_install_link_sim.py | uv (agi-cluster) |
| agilab | mycode get_distrib | /Users/agi/log/execute/mycode/AGI_get_distrib_mycode.py |  | /Users/agi/log/execute/mycode | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/mycode && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/mycode/AGI_get_distrib_mycode.py | uv (mycode_project) |
| agilab | mycode install | /Users/agi/log/execute/mycode/AGI_install_mycode.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/mycode/AGI_install_mycode.py | uv (agi-cluster) |
| agilab | network_sim get_distrib | /Users/agi/log/execute/network_sim/AGI_get_distrib_network_sim.py |  | /Users/agi/log/execute/network_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/network_sim && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/network_sim/AGI_get_distrib_network_sim.py | uv (network_sim_project) |
| agilab | network_sim install | /Users/agi/log/execute/network_sim/AGI_install_network_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/network_sim/AGI_install_network_sim.py | uv (agi-cluster) |
| agilab | publish dry-run (testpypi) | $ProjectFileDir$/tools/pypi_publish.py | --repo testpypi --dry-run --leave-most-recent --verbose | $ProjectFileDir$ | PYTHONUNBUFFERED=1 PYDEVD_USE_FRAME_EVAL=NO;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/pypi_publish.py --repo testpypi --dry-run --leave-most-recent --verbose | uv (agilab) |
| agilab | pypi publish | $ProjectFileDir$/tools/pypi_publish.py | --repo pypi --leave-most-recent --verbose --cleanup $Prompt:Cleanup credentials$ | $ProjectFileDir$ | PYTHONUNBUFFERED=1 PYDEVD_USE_FRAME_EVAL=NO;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/pypi_publish.py --repo pypi --leave-most-recent --verbose --cleanup $Prompt:Cleanup credentials$ | uv (agilab) |
| agilab | run ssh cmd | $ProjectFileDir$/src/agilab/core/agi-env/test/_test_ssh_cmd.py |  |  | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/core/agi-env/test/_test_ssh_cmd.py |  |
| agilab | sat_trajectory get_distrib | /Users/agi/log/execute/sat_trajectory/AGI_get_distrib_sat_trajectory.py |  | /Users/agi/log/execute/sat_trajectory | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/sat_trajectory && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sat_trajectory/AGI_get_distrib_sat_trajectory.py | uv (sat_trajectory_project) |
| agilab | sat_trajectory install | /Users/agi/log/execute/sat_trajectory/AGI_install_sat_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sat_trajectory/AGI_install_sat_trajectory.py | uv (agi-cluster) |
| agilab | sb3_trainer get_distrib | /Users/agi/log/execute/sb3_trainer/AGI_get_distrib_sb3_trainer.py |  | /Users/agi/log/execute/sb3_trainer | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/log/execute/sb3_trainer && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sb3_trainer/AGI_get_distrib_sb3_trainer.py | uv (sb3_trainer_project) |
| agilab | sb3_trainer install | /Users/agi/log/execute/sb3_trainer/AGI_install_sb3_trainer.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sb3_trainer/AGI_install_sb3_trainer.py | uv (agi-cluster) |
| agilab | show depencencies | $ProjectFileDir$/tools/show_dependencies.py | --repo pypi | $ProjectFileDir$ | PYTHONUNBUFFERED=1 PYDEVD_USE_FRAME_EVAL=NO;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/show_dependencies.py --repo pypi | uv (agilab) |
| agilab | test agi_distributor |  |  | $PROJECT_DIR$/src/agilab/core/agi-cluster |  | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | test agi_env |  |  | $ProjectFileDir$/src/agilab/core/agi-env/test |  | cd $ProjectFileDir$/src/agilab/core/agi-env/test && uv --preview-features extra-build-dependencies run python | uv (agi-env) |
| agilab | test base_worker |  |  |  |  | uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | test dag_worker |  |  |  |  | uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | test pandas_worker |  |  | $PROJECT_DIR$/src/agilab/core/agi-cluster |  | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | test polars_worker |  |  | $PROJECT_DIR$/src/agilab/core/agi-cluster |  | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | test pypi publish | $ProjectFileDir$/tools/pypi_publish.py | --repo testpypi --leave-most-recent --verbose --cleanup $Prompt:Cleanup credentials$ | $ProjectFileDir$ | PYTHONUNBUFFERED=1 PYDEVD_USE_FRAME_EVAL=NO;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/pypi_publish.py --repo testpypi --leave-most-recent --verbose --cleanup $Prompt:Cleanup credentials$ | uv (agilab) |
| agilab | test work_dispatcher |  |  |  |  | uv --preview-features extra-build-dependencies run python | uv (agi-cluster) |
| agilab | zip_all | $ProjectFileDir$/tools/zip_all.py | --dir2zip src --zipfile src.zip --follow-app-links | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/tools/zip_all.py --dir2zip src --zipfile src.zip --follow-app-links |  |
| apps | app install (local) | $ProjectFileDir$/src/agilab/apps/install.py | $Prompt:selected app:~/PycharmProjects/agilab/src/agilab/apps/flight_project$ --install-type "1" --verbose 1 | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/install.py $Prompt:selected app:~/PycharmProjects/agilab/src/agilab/apps/flight_project$ --install-type "1" --verbose 1 | uv (agi-cluster) |
| apps | app-test | $ProjectFileDir$/src/agilab/apps/$Prompt:Enter app manager name:flight$_project/app_test.py |  |  | PYTHONUNBUFFERED=1 | uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/$Prompt:Enter app manager name:flight$_project/app_test.py | uv (agi-cluster) |
| apps | flight run | $USER_HOME$/log/execute/flight/AGI_run_flight.py |  | $ProjectFileDir$/src/agilab/apps/flight_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python $USER_HOME$/log/execute/flight/AGI_run_flight.py | uv (flight_project) |
...
| apps | flight_trajectory run | /Users/agi/log/execute/flight_trajectory/AGI_run_flight_trajectory.py |  | $ProjectFileDir$/src/agilab/apps/flight_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_trajectory_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/flight_trajectory/AGI_run_flight_trajectory.py | uv (flight_trajectory_project) |
...
| apps | ilp run | /Users/agi/log/execute/ilp/AGI_run_ilp.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/ilp/AGI_run_ilp.py | uv (ilp_project) |
| apps | ilp test manager | $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_manager.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_manager.py | uv (ilp_project) |
| apps | link_sim run | /Users/agi/log/execute/link_sim/AGI_run_link_sim.py |  | $ProjectFileDir$/src/agilab/apps/link_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/link_sim_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/link_sim/AGI_run_link_sim.py | uv (link_sim_project) |
...
| apps | mycode run | /Users/agi/log/execute/mycode/AGI_run_mycode.py |  | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/mycode/AGI_run_mycode.py | uv (mycode_project) |
...
| apps | mycode tests | $ProjectFileDir$/src/agilab/apps/mycode_project/app_test.py |  | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/mycode_project/app_test.py | uv (mycode_project) |
| apps | network_sim run | /Users/agi/log/execute/network_sim/AGI_run_network_sim.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/network_sim/AGI_run_network_sim.py | uv (network_sim_project) |
| apps | network_sim test manager | $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_manager.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_manager.py | uv (network_sim_project) |
| apps | sat_trajectory run | /Users/agi/log/execute/sat_trajectory/AGI_run_sat_trajectory.py |  | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sat_trajectory/AGI_run_sat_trajectory.py | uv (sat_trajectory_project) |
...
| apps | sb3_trainer run | /Users/agi/log/execute/sb3_trainer/AGI_run_sb3_trainer.py |  | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python /Users/agi/log/execute/sb3_trainer/AGI_run_sb3_trainer.py | uv (sb3_trainer_project) |
...
| components | flight_trajectory_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_trajectory_worker/src/flight_trajectory_worker/flight_trajectory_worker.py | $ProjectFileDir$/src/agilab/apps/flight_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_trajectory_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_trajectory_worker/src/flight_trajectory_worker/flight_trajectory_worker.py | uv (flight_trajectory_project) |
| components | ilp call worker | $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_call_worker.py | uv (ilp_project) |
| components | ilp test worker | $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_worker.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/ilp_project/test/_test_ilp_worker.py | uv (ilp_worker) |
| components | ilp_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/ilp_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/ilp_worker | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/ilp_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/ilp_worker | uv (ilp_project) |
| components | ilp_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/agi/wenv/ilp_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/ilp_worker | /Users/agi/wenv/ilp_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/wenv/ilp_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/agi/wenv/ilp_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/ilp_worker | uv (ilp_worker) |
| components | ilp_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/ilp_project /Users/agi/data/ilp | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/ilp_project /Users/agi/data/ilp | uv (ilp_worker) |
| components | ilp_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/agi/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/agi/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | uv (ilp_project) |
...
| components | mycode_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/mycode_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/mycode_worker | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/mycode_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/mycode_worker | uv (mycode_project) |
| components | mycode_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/agi/wenv/mycode_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/mycode_worker | /Users/agi/wenv/mycode_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/wenv/mycode_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/agi/wenv/mycode_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/mycode_worker | uv (mycode_worker) |
| components | mycode_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/mycode_project /Users/agi/data/mycode | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/mycode_project /Users/agi/data/mycode | uv (mycode_worker) |
| components | mycode_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/agi/wenv/mycode_worker/src/mycode_worker/mycode_worker.py | $ProjectFileDir$/src/agilab/apps/mycode_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/agi/wenv/mycode_worker/src/mycode_worker/mycode_worker.py | uv (mycode_project) |
| components | network_sim call worker | $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_call_worker.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_call_worker.py | uv (network_sim_project) |
| components | network_sim test worker | $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_worker.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $ProjectFileDir$/src/agilab/apps/network_sim_project/test/_test_network_sim_worker.py | uv (network_sim_worker) |
| components | network_sim_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/network_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/network_sim_worker | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/network_sim_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/network_sim_worker | uv (network_sim_project) |
| components | network_sim_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/agi/wenv/network_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/network_sim_worker | /Users/agi/wenv/network_sim_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/wenv/network_sim_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/agi/wenv/network_sim_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/network_sim_worker | uv (network_sim_worker) |
| components | network_sim_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/network_sim_project /Users/agi/data/network_sim | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/network_sim_project /Users/agi/data/network_sim | uv (network_sim_worker) |
| components | network_sim_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/agi/wenv/network_sim_worker/src/network_sim_worker/network_sim_worker.py | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/agi/wenv/network_sim_worker/src/network_sim_worker/network_sim_worker.py | uv (network_sim_project) |
...
| components | sat_trajectory_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/sat_trajectory_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/sat_trajectory_worker | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/sat_trajectory_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/sat_trajectory_worker | uv (sat_trajectory_project) |
| components | sat_trajectory_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/agi/wenv/sat_trajectory_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/sat_trajectory_worker | /Users/agi/wenv/sat_trajectory_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/wenv/sat_trajectory_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/agi/wenv/sat_trajectory_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/sat_trajectory_worker | uv (sat_trajectory_worker) |
| components | sat_trajectory_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project /Users/agi/data/sat_trajectory | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/sat_trajectory_project /Users/agi/data/sat_trajectory | uv (sat_trajectory_worker) |
| components | sat_trajectory_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/agi/wenv/sat_trajectory_worker/src/sat_trajectory_worker/sat_trajectory_worker.py | $ProjectFileDir$/src/agilab/apps/sat_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/agi/wenv/sat_trajectory_worker/src/sat_trajectory_worker/sat_trajectory_worker.py | uv (sat_trajectory_project) |
...
| components | sb3_trainer_egg gen | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py | --app-path $PROJECT_DIR$/src/agilab/apps/sb3_trainer_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/sb3_trainer_worker | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/build.py --app-path $PROJECT_DIR$/src/agilab/apps/sb3_trainer_project bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d /Users/agi/wenv/sb3_trainer_worker | uv (sb3_trainer_project) |
| components | sb3_trainer_lib gen | agi_node.agi_dispatcher.build | --app-path /Users/agi/wenv/sb3_trainer_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/sb3_trainer_worker | /Users/agi/wenv/sb3_trainer_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd /Users/agi/wenv/sb3_trainer_worker && uv --preview-features extra-build-dependencies run python agi_node.agi_dispatcher.build --app-path /Users/agi/wenv/sb3_trainer_worker build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b /Users/agi/wenv/sb3_trainer_worker | uv (sb3_trainer_worker) |
| components | sb3_trainer_postinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project /Users/agi/data/sb3_trainer | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/post_install.py $ProjectFileDir$/src/agilab/apps/sb3_trainer_project /Users/agi/data/sb3_trainer | uv (sb3_trainer_worker) |
| components | sb3_trainer_preinstall test | $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py | remove_decorators --verbose --worker_path /Users/agi/wenv/sb3_trainer_worker/src/sb3_trainer_worker/sb3_trainer_worker.py | $ProjectFileDir$/src/agilab/apps/sb3_trainer_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python $PROJECT_DIR$/src/agilab/core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path /Users/agi/wenv/sb3_trainer_worker/src/sb3_trainer_worker/sb3_trainer_worker.py | uv (sb3_trainer_project) |
</details>
...
- Sphinx docs in thales_agilab: from that repo, run `uv --preview-features extra-build-dependencies run --group sphinx --dev docs/gen-docs.py`. If a sibling `agilab` checkout is present, the generator writes directly to `../agilab/docs/html/`; otherwise it builds into `docs/html/` in `thales_agilab`.
...
- Troubleshooting:
  - Missing Python deps (e.g., `tomlkit`, `licensecheck`): run with `uv --preview-features extra-build-dependencies run --group sphinx --dev docs/gen-docs.py` from thales_agilab.
...
- Flight: run → test manager/worker → distribute → call → pre/postinstall
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python ../../examples/flight/AGI_run_flight.py`
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python test/_test_flight_manager.py`
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python test/_test_flight_worker.py`
  - `cd src/agilab/examples/flight && uv --preview-features extra-build-dependencies run python AGI_get_distrib_flight.py`
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python ../../core/agi-node/src/agi_node/agi_dispatcher/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/flight_worker/src/flight_worker/flight_worker.py`
  - `cd src/agilab/apps/flight_project && uv --preview-features extra-build-dependencies run python ../../core/agi-node/src/agi_node/agi_dispatcher/post_install.py src/agilab/apps/flight_project $USER_HOME$/data/flight`
- LinkSim:
  - `cd src/agilab/apps/link_sim_project && uv --preview-features extra-build-dependencies run python ../../examples/link_sim/AGI_run_link_sim.py`
  - `cd src/agilab/apps/link_sim_project && uv --preview-features extra-build-dependencies run python test/_test_link_sim_manager.py`
  - `cd src/agilab/apps/link_sim_project && uv --preview-features extra-build-dependencies run python test/_test_link_sim_worker.py`
  - `cd src/agilab/examples/link_sim && uv --preview-features extra-build-dependencies run python AGI_get_distrib_link_sim.py`
  - `cd src/agilab/apps/link_sim_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
- MyCode:
  - `cd src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python ../../examples/mycode/AGI_run_mycode.py`
  - `cd src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python test/_test_mycode_manager.py`
  - `cd src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python test/_test_mycode_worker.py`
  - `cd src/agilab/examples/mycode && uv --preview-features extra-build-dependencies run python AGI_get_distrib_mycode.py`
  - `cd src/agilab/apps/mycode_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
- SatTrajectory:
  - `cd src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python ../../examples/sat_trajectory/AGI_run_sat_trajectory.py`
  - `cd src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python test/_test_sat_trajectory_manager.py`
  - `cd src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python test/_test_sat_trajectory_worker.py`
  - `cd src/agilab/examples/sat_trajectory && uv --preview-features extra-build-dependencies run python AGI_get_distrib_sat_trajectory.py`
  - `cd src/agilab/apps/sat_trajectory_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
- Sb3Trainer:
  - `cd src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python ../../examples/sb3_trainer/AGI_run_sb3_trainer.py`
  - `cd src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python test/_test_sb3_trainer_manager.py`
  - `cd src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python test/_test_sb3_trainer_worker.py`
  - `cd src/agilab/examples/sb3_trainer && uv --preview-features extra-build-dependencies run python AGI_get_distrib_sb3_trainer.py`
  - `cd src/agilab/apps/sb3_trainer_project && uv --preview-features extra-build-dependencies run python test/_test_call_worker.py`
...
- `uv --preview-features extra-build-dependencies run streamlit run src/agilab/apps-pages/view_maps/src/view_maps/view_maps.py -- --active-app src/agilab/apps/flight_project`
- `uv --preview-features extra-build-dependencies run streamlit run src/agilab/apps-pages/view_barycentric/src/view_barycentric/view_barycentric.py -- --active-app src/agilab/apps/flight_project`
- `▶️ EXECUTE` page tips:
...
3. Re-generate per‑app launchers (one per app)
   - Examples:
     ...
     - `uv --preview-features extra-build-dependencies run python pycharm/gen_app_script.py link_sim`
     - `uv --preview-features extra-build-dependencies run python pycharm/gen_app_script.py mycode`
     - `uv --preview-features extra-build-dependencies run python pycharm/gen_app_script.py sat_trajectory`
     - `uv --preview-features extra-build-dependencies run python pycharm/gen_app_script.py sb3_trainer`
