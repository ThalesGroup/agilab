...
| apps | ilp get_distrib | $ProjectFileDir$/src/agilab/examples/ilp/AGI_get_distrib_ilp.py |  | $ProjectFileDir$/src/agilab/examples/ilp | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/examples/ilp && uv run python $ProjectFileDir$/src/agilab/examples/ilp/AGI_get_distrib_ilp.py | uv (ilp_project) |
...
| apps | ilp run | $ProjectFileDir$/src/agilab/examples/ilp/AGI_run_ilp.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $ProjectFileDir$/src/agilab/examples/ilp/AGI_run_ilp.py | uv (ilp_project) |
| apps | ilp test | $ProjectFileDir$/src/agilab/apps/ilp_project/app_test.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $ProjectFileDir$/src/agilab/apps/ilp_project/app_test.py | uv (ilp_project) |
...
| apps | network_sim get_distrib | $ProjectFileDir$/src/agilab/examples/network_sim/AGI_get_distrib_network_sim.py |  | $ProjectFileDir$/src/agilab/examples/network_sim | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/examples/network_sim && uv run python $ProjectFileDir$/src/agilab/examples/network_sim/AGI_get_distrib_network_sim.py | uv (network_sim_project) |
| apps | network_sim install | $ProjectFileDir$/src/agilab/examples/network_sim/AGI_install_network_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/network_sim/AGI_install_network_sim.py | uv (agi-cluster) |
| apps | network_sim run | $ProjectFileDir$/src/agilab/examples/network_sim/AGI_run_network_sim.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv run python $ProjectFileDir$/src/agilab/examples/network_sim/AGI_run_network_sim.py | uv (network_sim_project) |
| apps | network_sim test | $ProjectFileDir$/src/agilab/apps/network_sim_project/app_test.py |  | $ProjectFileDir$/src/agilab/apps/network_sim_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/network_sim_project && uv run python $ProjectFileDir$/src/agilab/apps/network_sim_project/app_test.py | uv (network_sim_project) |
