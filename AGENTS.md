...
| agilab | install_agilab_dev |  |  |  |  | uv run python |  |
...
| agilab | pypi publish | $ProjectFileDir$/tools/pypi_publish.py | --repo pypi --user agilab --version 0.7.8 | $ProjectFileDir$ | PYTHONUNBUFFERED=1 PYDEVD_USE_FRAME_EVAL=NO;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/tools/pypi_publish.py --repo pypi --user agilab --version 0.7.8 | uv (agilab) |
...
| apps | flight_trajectory AGI.install | $ProjectFileDir$/src/agilab/examples/flight_trajectory/AGI.install_flight_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/flight_trajectory/AGI.install_flight_trajectory.py | uv (agi-cluster) |
...
| apps | flight_trajectory_egg gen | $PROJECT_DIR$/src/agilab/apps/flight_trajectory_project/build.py | bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_trajectory_worker | $ProjectFileDir$/src/agilab/apps/flight_trajectory_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/flight_trajectory_project && uv run python $PROJECT_DIR$/src/agilab/apps/flight_trajectory_project/build.py bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/flight_trajectory_worker | uv (flight_trajectory_project) |
| apps | ilp AGI.get_distrib | $ProjectFileDir$/src/agilab/examples/ilp/AGI.get_distrib_ilp.py |  | $ProjectFileDir$/src/agilab/examples/ilp | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/examples/ilp && uv run python $ProjectFileDir$/src/agilab/examples/ilp/AGI.get_distrib_ilp.py | uv (ilp_project) |
| apps | ilp AGI.install | $ProjectFileDir$/src/agilab/examples/ilp/AGI.install_ilp.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/ilp/AGI.install_ilp.py | uv (agi-cluster) |
| apps | ilp AGI.run | $ProjectFileDir$/src/agilab/examples/ilp/AGI.run_ilp.py |  | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $ProjectFileDir$/src/agilab/examples/ilp/AGI.run_ilp.py | uv (ilp_project) |
...
| apps | ilp_egg gen | $PROJECT_DIR$/src/agilab/apps/ilp_project/build.py | bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/ilp_worker | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $PROJECT_DIR$/src/agilab/apps/ilp_project/build.py bdist_egg --packages "agent_worker, pandas_worker, polars_worker, dag_worker" -d $USER_HOME$/wenv/ilp_worker | uv (ilp_project) |
...
| apps | link_sim AGI.install | $ProjectFileDir$/src/agilab/examples/link_sim/AGI.install_link_sim.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/link_sim/AGI.install_link_sim.py | uv (agi-cluster) |
...
| apps | sat_trajectory AGI.install | $ProjectFileDir$/src/agilab/examples/sat_trajectory/AGI.install_sat_trajectory.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/sat_trajectory/AGI.install_sat_trajectory.py | uv (agi-cluster) |
...
| apps | sb3_trainer AGI.install | $ProjectFileDir$/src/agilab/examples/sb3_trainer/AGI.install_sb3_trainer.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/examples/sb3_trainer/AGI.install_sb3_trainer.py | uv (agi-cluster) |
...
| components | ilp_lib gen | $USER_HOME$/wenv/ilp_worker/build.py | build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/ilp_worker | $USER_HOME$/wenv/ilp_worker | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $USER_HOME$/wenv/ilp_worker && uv run python $USER_HOME$/wenv/ilp_worker/build.py build_ext --packages "dag_worker, pandas_worker, polars_worker, agent_worker" -b $USER_HOME$/wenv/ilp_worker | uv (ilp_worker) |
| components | ilp_postinstall test | $USER_HOME$/wenv/ilp_worker/src/ilp_worker/post_install.py | $ProjectFileDir$/src/agilab/apps/ilp_project 1 $USER_HOME$/data/ilp | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $USER_HOME$/wenv/ilp_worker/src/ilp_worker/post_install.py $ProjectFileDir$/src/agilab/apps/ilp_project 1 $USER_HOME$/data/ilp | uv (ilp_worker) |
| components | ilp_preinstall test | $PROJECT_DIR$/src/agilab/apps/ilp_project/src/ilp_worker/pre_install.py | remove_decorators --verbose --worker_path $USER_HOME$/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | $ProjectFileDir$/src/agilab/apps/ilp_project | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/src/agilab/apps/ilp_project && uv run python $PROJECT_DIR$/src/agilab/apps/ilp_project/src/ilp_worker/pre_install.py remove_decorators --verbose --worker_path $USER_HOME$/wenv/ilp_worker/src/ilp_worker/ilp_worker.py | uv (ilp_project) |
