...
|---|---|---|---|---|---|---|---|
| agilab | agilab run (dev) |  | run $ProjectFileDir$/src/agilab/AGILAB.py -- --install-type 1 --openai-api-key "your-key" --apps-dir $ProjectFileDir$/src/agilab/apps | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run  run $ProjectFileDir$/src/agilab/AGILAB.py -- --install-type 1 --openai-api-key "your-key" --apps-dir $ProjectFileDir$/src/agilab/apps | uv (agilab) |
| agilab | agilab run (enduser) |  | run .venv/lib/python3.13/site-packages/agilab/AGILAB.py -- --openai-api-key "your-key" --install 0 | $ProjectFileDir$/../agi-space | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/../agi-space && uv run  run .venv/lib/python3.13/site-packages/agilab/AGILAB.py -- --openai-api-key "your-key" --install 0 | uv (agi-space) |
...
| agilab | app_script gen | $ProjectFileDir$/pycharm/gen_app_script.py | $Prompt:Enter app manager name:flight$ | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/pycharm/gen_app_script.py $Prompt:Enter app manager name:flight$ | uv (agi-cluster) |
...
| agilab | run ssh cmd | $ProjectFileDir$/src/agilab/core/agi-env/test/_test_ssh_cmd.py |  | $ProjectFileDir$ | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$ && uv run python $ProjectFileDir$/src/agilab/core/agi-env/test/_test_ssh_cmd.py | uv (agi-cluster) |
...
| agilab | test agi_distributor |  | $PROJECT_DIR$/src/agilab/core/test/test_agi_distributor.py | $PROJECT_DIR$/src/agilab/core/agi-cluster | UV_NO_SYNC=1 | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv run  $PROJECT_DIR$/src/agilab/core/test/test_agi_distributor.py | uv (agi-cluster) |
| agilab | test agi_env |  | -q --cov\u003dagi_env test_agi_env.py $PROJECT_DIR$/src/agilab/core/agi-env/test/test_agi_env.py | $ProjectFileDir$/src/agilab/core/agi-env/test |  | cd $ProjectFileDir$/src/agilab/core/agi-env/test && uv run  -q --cov\u003dagi_env test_agi_env.py $PROJECT_DIR$/src/agilab/core/agi-env/test/test_agi_env.py | uv (agi-env) |
| agilab | test base_worker |  | $PROJECT_DIR$/src/agilab/core/test/test_base_worker.py | $PROJECT_DIR$ |  | cd $PROJECT_DIR$ && uv run  $PROJECT_DIR$/src/agilab/core/test/test_base_worker.py | uv (agi-cluster) |
| agilab | test dag_worker |  | $PROJECT_DIR$/src/agilab/core/test/test_dag_worker.py | $PROJECT_DIR$ |  | cd $PROJECT_DIR$ && uv run  $PROJECT_DIR$/src/agilab/core/test/test_dag_worker.py | uv (agi-cluster) |
| agilab | test pandas_worker |  | $PROJECT_DIR$/src/agilab/core/test/test_pandas_worker.py | $PROJECT_DIR$/src/agilab/core/agi-cluster |  | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv run  $PROJECT_DIR$/src/agilab/core/test/test_pandas_worker.py | uv (agi-cluster) |
| agilab | test polars_worker |  | $PROJECT_DIR$/src/agilab/core/test/test_polars_worker.py | $PROJECT_DIR$/src/agilab/core/agi-cluster |  | cd $PROJECT_DIR$/src/agilab/core/agi-cluster && uv run  $PROJECT_DIR$/src/agilab/core/test/test_polars_worker.py | uv (agi-cluster) |
| agilab | test work_dispatcher |  | $PROJECT_DIR$/src/agilab/core/test/test_work_dispatcher.py | $PROJECT_DIR$ |  | cd $PROJECT_DIR$ && uv run  $PROJECT_DIR$/src/agilab/core/test/test_work_dispatcher.py | uv (agi-cluster) |
| agilab | zip_all gen | $ProjectFileDir$/../../tools/zip_all.py | --dir2zip src --zipfile src.zip | $ProjectFileDir$/../../tools | PYTHONUNBUFFERED=1;UV_NO_SYNC=1 | cd $ProjectFileDir$/../../tools && uv run python $ProjectFileDir$/../../tools/zip_all.py --dir2zip src --zipfile src.zip | uv (agi-cluster) |
