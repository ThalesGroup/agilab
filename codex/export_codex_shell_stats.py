...
def get_command_help(command: str) -> tuple[str, str]:
    ...
    if command.startswith("/Users/agi/PycharmProjects/agilab/src/agilab/apps/flight_project/.venv/bin/python") or command.startswith("/Users/agi/PycharmProjects/agilab/src/agilab/apps/flight_trajectory_project/.venv/bin/python"):
