...
This page is a generated inventory of **third-party Python packages** used by the component at documentation build time.
It does **not** change the AGILab source license; refer to the repository root `LICENSE`/`NOTICE` and any vendored license texts under `LICENSES/`.

| Package Name | License |
|--------------|---------|
| agi-cluster | BSD-3-Clause |
| agi-env | BSD-3-Clause |
| agi-node | BSD-3-Clause |
| altair | BSD LICENSE |
...
| ipython-pygments-lexers | BSD LICENSE |
...
| pynacl | APACHE SOFTWARE LICENSE |
| pyppmd | LGPL-2.1-OR-LATER |
...
| rfc3987-syntax | APACHE SOFTWARE LICENSE |
| rpds-py | MIT |
| scikit-learn | BSD-3-CLAUSE |
| scipy | BSD LICENSE |
| scp | GNU LIBRARY;; LESSER GENERAL PUBLIC LICENSE _LGPL_ |
| send2trash | BSD-3-CLAUSE |
| setuptools | MIT |
| six | MIT LICENSE |
| smmap | BSD LICENSE |
| sortedcontainers | APACHE SOFTWARE LICENSE |
