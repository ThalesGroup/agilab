...
| databricks-sdk | 0.112.0 | APACHE SOFTWARE LICENSE |
...
| docutils | 0.23 | BSD LICENSE;; GNU GENERAL PUBLIC LICENSE _GPL_;; PUBLIC DOMAIN |
...
| httpx-sse | 0.4.3 | MIT |
| huey | 2.6.0 | MIT |
| huggingface-hub | 1.17.0 | APACHE SOFTWARE LICENSE |
| humanize | 4.15.0 | MIT |
...
| jupyter-server | 2.19.0 | BSD LICENSE |
