...
.. list-table::
   ...
   * - Item
     - Public evidence
   * - Package version
     - ``agilab[examples]==2026.06.17`` on `PyPI <https://pypi.org/project/agilab/>`__
   * - GitHub release
     - `v2026.06.17 <https://github.com/ThalesGroup/agilab/releases/tag/v2026.06.17>`__
   * - Dataset manifest
   ...
   * - Hosted demo
     - `jpmorard/agilab <https://huggingface.co/spaces/jpmorard/agilab>`__ at Space commit ``bf6f9887c39529b519f8586c74f6c9232b482486``
   * - Public guardrails
...
- A clean package install can run the public first proof:
  ...
  .. code-block:: bash
     ...
     python -m pip install "agilab[examples]==2026.06.17"
