...
.. list-table::
   ...
   * - Item
     - Public evidence
   * - Package version
     - ``agilab[examples]==2026.05.15.post1`` on `PyPI <https://pypi.org/project/agilab/>`__
   * - GitHub release
     - `v2026.05.15-2 <https://github.com/ThalesGroup/agilab/releases/tag/v2026.05.15-2>`__
   * - Hosted demo
     - `jpmorard/agilab <https://huggingface.co/spaces/jpmorard/agilab>`__ at Space commit ``cb86a1ee026f6c6fc22644fb0c89fa88f4353c85``
   * - Public guardrails
...
- A clean package install can run the public first proof:
  ...
  .. code-block:: bash
     ...
     python -m pip install "agilab[examples]==2026.05.15.post1"
