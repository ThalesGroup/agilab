...
.. list-table::
   ...
   * - Public guardrails
     - `repo-guardrails run 26689213216 <https://github.com/ThalesGroup/agilab/actions/runs/26689213216>`__ passed repository guardrails and clean package first-proof jobs
   * - Docs source guard
     - `docs-source-guard run 26689213222 <https://github.com/ThalesGroup/agilab/actions/runs/26689213222>`__ passed docs mirror and release-proof consistency checks
   * - Docs publish
     - `docs-publish run 26689213204 <https://github.com/ThalesGroup/agilab/actions/runs/26689213204>`__ built the public documentation from the managed docs mirror
   * - Coverage
