...
.. list-table::
   ...
   * - Item
     - Public evidence
   * - Package version
     - ``agilab[examples]==2026.05.17.post2`` on `PyPI <https://pypi.org/project/agilab/>`__
   * - GitHub release
     - `v2026.05.17-6 <https://github.com/ThalesGroup/agilab/releases/tag/v2026.05.17-6>`__
   * - Hosted demo
   ...
   * - PyPI publish
     - `pypi-publish run 25971244152 <https://github.com/ThalesGroup/agilab/actions/runs/25971244152>`__ published the 2026.05.17.post2 package after preflight, release evidence, and supply-chain evidence passed; GitHub release evidence is recorded under v2026.05.17-5
...
- A clean package install can run the public first proof:
  ...
  .. code-block:: bash
     ...
     python -m pip install "agilab[examples]==2026.05.17.post2"
