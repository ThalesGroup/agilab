...
.. list-table::
   ...
   * - Item
     - Public evidence
   * - Package version
     - ``agilab[examples]==2026.05.11`` on `PyPI <https://pypi.org/project/agilab/>`__
   * - GitHub release
     - `v2026.05.11-5 <https://github.com/ThalesGroup/agilab/releases/tag/v2026.05.11-5>`__
   * - Hosted demo
...
- A clean package install can run the public first proof:
  ...
  .. code-block:: bash
     ...
     python -m pip install agilab[examples]==2026.05.11
