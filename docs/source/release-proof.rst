...
.. list-table::
   ...
   * - Public guardrails
     - `repo-guardrails run 26689079579 <https://github.com/ThalesGroup/agilab/actions/runs/26689079579>`__ passed repository guardrails and clean package first-proof jobs
   * - Docs source guard
     - `docs-source-guard run 26689079594 <https://github.com/ThalesGroup/agilab/actions/runs/26689079594>`__ passed docs mirror and release-proof consistency checks
   * - Docs publish
     - `docs-publish run 26689079585 <https://github.com/ThalesGroup/agilab/actions/runs/26689079585>`__ built the public documentation from the managed docs mirror
   * - Coverage
